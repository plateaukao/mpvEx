...
class AppearancePreferences(
  ...
  val bottomRightControls =
    preferenceStore.getString(
      ...
      "VIDEO_ZOOM,ASPECT_RATIO",
    )

  val bottomLeftControls =
    preferenceStore.getString(
      "bottom_left_controls",
      "PREVIOUS,PLAY_PAUSE,NEXT,BACKGROUND_PLAYBACK,LOCK_CONTROLS,SCREEN_ROTATION,PLAYBACK_SPEED,SHUFFLE,AB_LOOP",
    )

  val portraitBottomControls =
    preferenceStore.getString(
      "portrait_bottom_controls",
      "PREVIOUS,PLAY_PAUSE,NEXT,SCREEN_ROTATION,DECODER,AUDIO_TRACK,SUBTITLES,BOOKMARKS_CHAPTERS,PLAYBACK_SPEED,BACKGROUND_PLAYBACK,SHUFFLE,VIDEO_ZOOM,ASPECT_RATIO,LOCK_CONTROLS,MORE_OPTIONS",
    )
